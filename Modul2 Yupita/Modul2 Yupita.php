...
// silakan taruh code kalian di bawah
    if ($tinggi == 0 and $berat==0){
        $hasilnya= "ayo masukan dulu tinggi badannya";
    }elseif ($berat == 0){
        $hasilnya= " ayo masukan dulu beratnya";
    }elseif ($tinggi == 0) {
        $hasilnya= "ayo masukan dulu tingginy ";
    }else{
...
// silakan taruh code kalian di bawah
        $hasilnya = $berat/ ($tinggi/100 * $tinggi/100);  
    }
    }
        ...
        <div class="col-md-4 p-3">
            <div class="card">
                <div class="card-body">
                    ...
                    if ($hasilnya <= 18.4){
                        echo " Underweight";
                    }elseif ($hasilnya >= 18.5){
                       echo " normal";
                    }elseif ($hasilnya >= 25.0) {
                        echo "overweight ";
                    }elseif ($hasilnya>= 40) {
                        echo "overweight ";
                    }
